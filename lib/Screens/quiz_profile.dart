...
import 'package:quizz/Screens/quiz_settings.dart';
      ...
      child: Column(
        children: <Widget>[
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(color: quizwhite, width: 4)),
                child: CircleAvatar(
                    backgroundImage:
                        const CachedNetworkImageProvider(quizimgPeople2),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.all(color: quizwhite, width: 2),
                    color: quizwhite),
          ...
          Container(
            width: width,
            decoration: boxDecoration(
                radius: spacingmiddle, bgColor: quizwhite, showShadow: false),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                            selectedPos == 1 ? quizwhite : Colors.transparent,
                        border: Border.all(
                            color: selectedPos == 1
                                ? quizwhite
                                : Colors.transparent),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                            selectedPos == 2 ? quizwhite : Colors.transparent,
                        border: Border.all(
                            color: selectedPos == 2
                                ? quizwhite
                                : Colors.transparent),
          ...
          selectedPos == 1
              ? Container(
                  decoration: boxDecoration(
                      bgColor: quizwhite, radius: 10, showShadow: true),
