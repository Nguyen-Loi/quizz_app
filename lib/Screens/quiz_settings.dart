                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          quizSettingOptionPattern1(Icons.person,
                                  quizlbleditprofile, quizusername)
                              .onTap(() {
                            setState(() {
                              const RepoScreen(enableAppbar: true)
                                  .launch(context);
                            });
                          }),
                          quizSettingOptionPattern1(
                                  Icons.email, quizlblemail, quizemail)
                              .onTap(() {
                            setState(() {
                              const RepoScreen(enableAppbar: true)
                                  .launch(context);
                          ...
                          quizSettingOptionPattern1(Icons.vpn_key,
                                  quizlblpassword, quizsubinfopassword)
                              .onTap(() {
                            setState(() {
                              const RepoScreen(enableAppbar: true)
                                  .launch(context);
                      ...
                      child: Column(
                        children: <Widget>[
                          quizSettingOptionPattern2(
                              Icons.star, quizlblscoreboard),
                          quizSettingOptionPattern2(
                              Icons.add_box, quizlblnewcourse),
                          quizSettingOptionPattern2(
                              Icons.notifications, quizlblstudyreminder),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          quizSettingOptionPattern3(Icons.help, quizlblhelp)
                              .onTap(() {
                            setState(() {
                              const RepoScreen(enableAppbar: true)
                                  .launch(context);
                          ...
                          quizSettingOptionPattern3(
                              Icons.security, quizlblprivacy),
                          quizSettingOptionPattern3(
                                  Icons.chat_bubble, quizlblcontactus)
                              .onTap(() {
                            setState(() {
                              const RepoScreen(enableAppbar: true)
                                  .launch(context);
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Text(
                  info,
                  style:
                      primaryTextStyle(color: quiztextColorSecondary, size: 14),
                )
              ],
            ),
          ],
